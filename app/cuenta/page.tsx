...
export default async function AccountPage() {
  ...
  return <main className="shell profile-page">
    ...
    <footer className="profile-account-footer"><a href={signOutPath("/")} target="_top">Cerrar sesión</a><a href="mailto:contacto@modomza.com?subject=Privacidad%20-%20Mi%20cuenta">Solicitar acceso o eliminación de mis datos</a></footer>
  </main>;
}
